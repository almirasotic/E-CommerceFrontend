      ...
      <div class="column2">
        <div className="applied">
          ...
          <div className="applied2">
            Category: Fiction - HistoricalFiction -{" "}
            {names.map((name) => (
        ...
        <div className="zaprvukarticu">
          {isShown("Miller Madeline") && (
            <div className="kartica1">
              <img src="https://www.dubraybooks.ie/_next/image?url=https%3A%2F%2Fwww.bibdsl.co.uk%2Fbds-images%2Fl%2F978140%2F9781408890042.jpg&w=200&q=75"></img>
              <p>Circle P/B </p>
              <p></p>
              <h6>Miller Madeline</h6>
              <h5>$2.6</h5>
              <button
                onClick={() =>
                  addtocart("products65", {
                    id: "products65",
          ...
          {isShown("Pat Barker") && (
            <div className="kartica2">
              <img src="https://www.dubraybooks.ie/_next/image?url=https%3A%2F%2Fwww.bibdsl.co.uk%2Fbds-images%2Fl%2F978024%2F9780241988336.jpg&w=200&q=75"></img>
              <p>Women of Troy P/B</p>

              <h6>Pat Barker</h6>
              <h5>$9.79</h5>
              <button
                onClick={() =>
                  addtocart("products66", {
                    id: "products66",
          ...
          {isShown("Antoine Saint-Exupery") && (
            <div className="kartica3">
              <img src="https://www.dubraybooks.ie/_next/image?url=https%3A%2F%2Fwww.bibdsl.co.uk%2Fbds-images%2Fl%2F978147%2F9781472223821.jpg&w=200&q=75"></img>
              <p>Hamnet</p>

              <h6>O Farrel Maggie</h6>
              <h5>$10.12</h5>
              <button
                onClick={() =>
          ...
          {isShown("Emma Donoghue") && (
            <div className="kartica4">
              <img src="https://www.dubraybooks.ie/_next/image?url=https%3A%2F%2Fwww.bibdsl.co.uk%2Fbds-images%2Fl%2F978152%2F9781529091144.jpg&w=200&q=75"></img>
              <p>Haven TPN Roman Emma</p>
